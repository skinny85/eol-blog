...
but, the Truffle DSL did, in the `ReadTruffleStringPropertyExprNodeGen` class it generated,
...
We convert the property into a Java string, which is what `ReadTruffleStringPropertyExprNode` expects.
